...
with st.expander("""Why did I encounter errors when I tried to talk to the AI Samvadini?"""): 
    st.write(""" 
...
st.markdown("""\n""") 
jd = st.text_area("""Please enter Your job profile here (If you don't have one, enter keywords, such as "communication" or "teamwork" instead): """) 
auto_play = st.checkbox("Let AI Samvadini speak! (Please don't switch during the )") 
